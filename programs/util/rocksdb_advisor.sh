...
while (( "$#" )); do
   case "$1" in
      ...
      -p|--stats-dump-period)
         ...
         ;;
      -h|--help)
         echo "Specify data directory with '--data-dir' (Default is ~/.cread)"
         echo "Specify cread directory with '--cread-dir' (Default is ../..)"
...
cd "$CREAD_DIR/libraries/vendor/rocksdb/tools/advisor"
