...
namespace crea { namespace example_api_plugin {
...
FC_REFLECT( crea::example_api_plugin::hello_world_return, (message) )
FC_REFLECT( crea::example_api_plugin::echo_args, (call) )
FC_REFLECT( crea::example_api_plugin::echo_return, (response) )
