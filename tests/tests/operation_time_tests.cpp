...
BOOST_AUTO_TEST_CASE( comment_payout_equalize )
{
   try
   {
      ...
      //auto reward_crea = db->get_dynamic_global_properties().total_reward_fund_crea;
      ...
      */
      ...
      BOOST_CHECK( alice_account.reward_cbd_balance == ASSET( "10720.000 TBD" ) );
...
/*BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto reward_crea = db->get_dynamic_global_properties().total_reward_fund_crea + ASSET( "1.667 TESTS" );
      ...
      BOOST_REQUIRE( db->get_dynamic_global_properties().total_reward_fund_crea == reward_crea - bob_comment_payout );
...
BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto reward_crea = db->get_dynamic_global_properties().total_reward_fund_crea + ASSET( "2.000 TESTS" );
      auto total_rshares2 = db->get_dynamic_global_properties().total_reward_shares2;
      ...
      BOOST_REQUIRE( db->get_dynamic_global_properties().total_reward_fund_crea.amount.value == reward_crea.amount.value - ( bob_comment_payout + bob_comment_vote_rewards - unclaimed_payments ).amount.value );
      ...
      reward_crea = db->get_dynamic_global_properties().total_reward_fund_crea + ASSET( "2.000 TESTS" );
      ...
      BOOST_REQUIRE( ( db->get_dynamic_global_properties().total_reward_fund_crea + alice_comment_payout + alice_comment_vote_rewards - unclaimed_payments ).amount.value == reward_crea.amount.value );
...
BOOST_AUTO_TEST_CASE( nested_comments )
{
   try
   {
      ...
      auto gpo = db->get_dynamic_global_properties();
      uint128_t reward_crea = gpo.total_reward_fund_crea.amount.value + ASSET( "2.000 TESTS" ).amount.value;
...
BOOST_AUTO_TEST_CASE( crea_inflation )
{
   ...
   /*
      ...
      if ( db->get_account( witness_name ).vesting_shares.amount.value == 0 )
      {
         ...
         new_vesting_shares += witness_pay * ( gpo.total_vesting_shares / gpo.total_vesting_fund_crea );
      }

      auto new_supply = gpo.current_supply + new_rewards + witness_pay + new_vesting_crea;
      new_rewards += gpo.total_reward_fund_crea;
      new_vesting_crea += gpo.total_vesting_fund_crea;
      ...
      BOOST_REQUIRE( gpo.total_reward_fund_crea.amount.value == new_rewards.amount.value );
      BOOST_REQUIRE( gpo.total_vesting_fund_crea.amount.value == new_vesting_crea.amount.value );
      ...
      while( db->head_block_num() < CREA_START_VESTING_BLOCK - 1)
      {
         ...
         new_supply = gpo.current_supply + new_rewards + witness_pay + new_vesting_crea;
         new_rewards += gpo.total_reward_fund_crea;
         new_vesting_crea += gpo.total_vesting_fund_crea;
      ...
      for( int i = 0; i < CREA_BLOCKS_PER_DAY; i++ )
      {
         ...
         new_supply = gpo.current_supply + new_rewards + new_vesting_crea;
         new_rewards += gpo.total_reward_fund_crea;
         new_vesting_crea += gpo.total_vesting_fund_crea;
      ...
      vesting_crea = gpo.total_vesting_fund_crea;
      reward_crea = gpo.total_reward_fund_crea;
      ...
      BOOST_REQUIRE_EQUAL( gpo.total_vesting_fund_crea.amount.value,
      ...
      BOOST_REQUIRE_EQUAL( gpo.total_reward_fund_crea.amount.value,
...
BOOST_AUTO_TEST_CASE( cbd_interest )
{
   try
   {
      ...
      BOOST_REQUIRE( static_cast<uint64_t>(db->get_account( "alice" ).cbd_balance.amount.value) == alice_cbd.amount.value - ASSET( "1.000 TBD" ).amount.value + ( ( ( ( uint128_t( alice_cbd.amount.value ) * ( db->head_block_time() - start_time ).to_seconds() ) / CREA_SECONDS_PER_YEAR ) * gpo.cbd_interest_rate ) / CREA_100_PERCENT ).to_uint64() );
      ...
      BOOST_REQUIRE( static_cast<uint64_t>(db->get_account( "alice" ).cbd_balance.amount.value) == alice_cbd.amount.value - ASSET( "1.000 TBD" ).amount.value + ( ( ( ( uint128_t( alice_cbd.amount.value ) * ( db->head_block_time() - start_time ).to_seconds() + alice_coindays ) / CREA_SECONDS_PER_YEAR ) * gpo.cbd_interest_rate ) / CREA_100_PERCENT ).to_uint64() );
      validate_database();
   }
   FC_LOG_AND_RETHROW();
}
...
BOOST_AUTO_TEST_CASE( liquidity_rewards )
{
   ...
   try
   {
      ...
      asset alice_cbd = db->get_account( "alice" ).cbd_balance;
      ...
      BOOST_REQUIRE( reward->cbd_volume == alice_cbd_volume );
      BOOST_REQUIRE( reward->crea_volume == alice_crea_volume );
      ...
      BOOST_REQUIRE( reward->cbd_volume == bob_cbd_volume );
      BOOST_REQUIRE( reward->crea_volume == bob_crea_volume );
      ...
      BOOST_REQUIRE( reward->cbd_volume == sam_cbd_volume );
      BOOST_REQUIRE( reward->crea_volume == sam_crea_volume );
      ...
      BOOST_REQUIRE( reward->cbd_volume == dave_cbd_volume );
      BOOST_REQUIRE( reward->crea_volume == dave_crea_volume );
...
BOOST_AUTO_TEST_CASE( cbd_stability )
{
   try
   {
      ...
      BOOST_REQUIRE( db->get_dynamic_global_properties().cbd_print_rate == CREA_100_PERCENT );
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         ...
         {
            gpo.current_cbd_supply = cbd_balance;
      ...
      auto comment_reward = ( gpo.total_reward_fund_crea.amount + 2000 ) - ( ( gpo.total_reward_fund_crea.amount + 2000 ) * 25 * CREA_1_PERCENT ) / CREA_100_PERCENT ;
      comment_reward /= 2;
      auto cbd_reward = ( comment_reward * gpo.cbd_print_rate ) / CREA_100_PERCENT;
      auto alice_cbd = db->get_account( "alice" ).cbd_balance + db->get_account( "alice" ).reward_cbd_balance + asset( cbd_reward, CREA_SYMBOL ) * exchange_rate;
      auto alice_crea = db->get_account( "alice" ).balance + db->get_account( "alice" ).reward_crea_balance ;
      ...
      BOOST_REQUIRE( db->get_account( "alice" ).balance + db->get_account( "alice" ).reward_crea_balance > alice_crea );
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         db.modify( db.get_account( "sam" ), [&]( account_object& a )
         {
            a.cbd_balance = asset( ( ( gpo.cbd_start_percent - 6 ) * cbd_balance.amount ) / gpo.cbd_stop_percent, CBD_SYMBOL );
         });
      }, database::skip_witness_signature );
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         db.modify( db.get_dynamic_global_properties(), [&]( dynamic_global_property_object& gpo )
         {
            gpo.current_cbd_supply = alice_cbd + asset( ( ( gpo.cbd_start_percent - 6 ) * cbd_balance.amount ) / gpo.cbd_stop_percent, CBD_SYMBOL );
         });
      }, database::skip_witness_signature );
      ...
      while( ( db->get_dynamic_global_properties().current_cbd_supply * exchange_rate ).amount >= ( db->get_dynamic_global_properties().virtual_supply.amount * db->get_dynamic_global_properties().cbd_start_percent ) / CREA_100_PERCENT )
      {
         auto& gpo = db->get_dynamic_global_properties();
...
BOOST_AUTO_TEST_CASE( cbd_price_feed_limit )
{
   try
   {
      ...
      auto new_exchange_rate = price( gpo.current_cbd_supply, asset( ( CREA_100_PERCENT ) * gpo.current_supply.amount, CREA_SYMBOL ) );
...
BOOST_AUTO_TEST_CASE( clear_null_account )
{
   try
   {
      ...
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).cbd_balance == ASSET( "2.000 TBD" ) );
      ...
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).savings_cbd_balance == ASSET( "5.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_cbd_balance == ASSET( "1.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_crea_balance == ASSET( "1.000 TESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_vesting_balance == ASSET( "1.000000 VESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_vesting_crea == ASSET( "1.000 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).cbd_balance == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).vesting_shares == ASSET( "0.000000 VESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).savings_balance == ASSET( "0.000 TESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).savings_cbd_balance == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_cbd_balance == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_crea_balance == ASSET( "0.000 TESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_vesting_balance == ASSET( "0.000000 VESTS" ) );
      BOOST_REQUIRE( db->get_account( CREA_NULL_ACCOUNT ).reward_vesting_crea == ASSET( "0.000 TESTS" ) );
      BOOST_REQUIRE( db->get_account( "alice" ).balance == ASSET( "2.000 TESTS" ) );
      BOOST_REQUIRE( db->get_account( "alice" ).cbd_balance == ASSET( "3.000 TBD" ) );
   }
   FC_LOG_AND_RETHROW()
