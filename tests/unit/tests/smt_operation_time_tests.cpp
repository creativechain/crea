...
BOOST_AUTO_TEST_CASE( smt_liquidity_rewards )
{
  ...
  try
  {
    ...
    BOOST_REQUIRE( reward->get_cbd_volume() == alice_smt_volume );
    ...
    BOOST_REQUIRE( reward->get_cbd_volume() == bob_smt_volume );
    ...
    BOOST_REQUIRE( reward->get_cbd_volume() == sam_smt_volume );
    ...
    BOOST_REQUIRE( reward->get_cbd_volume() == dave_smt_volume );
