...
if __name__ == '__main__':
    ...
    # Example
    #./test-sigint-close.py --path "/home/mario/src/01.CREA-CREA/crea/build_release_main/programs/cread/cread" --dir "/home/mario/src/crea-data/" --block_limit 5000000 --wait_time 5
    parser.add_argument("--path", help = "Path to cread executable.", default="" )
    ...
    command_line = args.path + " -d " + args.dir + " --replay-blockchain --exit-after-replay --stop-replay-at-block " + str( args.block_limit )
