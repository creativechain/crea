...
MAIN_LOG_PATH = "hdf_proposal_payment_007.log"
...
if __name__ == '__main__':
    ...
    try:
        if node is None or node.is_running():
            ...
            crea_utils.common.debug_generate_blocks_until(node_client.rpc.url, wif, test_start_date_iso, False)
            ...
            while current_date < test_mid_date:
                ...
                crea_utils.common.debug_generate_blocks_until(node_client.rpc.url, wif, current_date_iso, False)
            ...
            crea_utils.common.debug_generate_blocks_until(node_client.rpc.url, wif, test_end_date_iso, False)
