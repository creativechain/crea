...
def print_balance(node, accounts):
    ...
    balances = []
    for acnt in accounts:
        ret = Account(acnt['name'], crea_instance=node).json()
        data = [
            acnt['name'],
            ret['balance']['amount'],
            ret['savings_balance']['amount'],
            ret['cbd_balance']['amount'],
            ret['savings_cbd_balance']['amount'],
            ret['reward_cbd_balance']['amount'],
            ret['reward_crea_balance']['amount'],
            ret['reward_vesting_balance']['amount'],
            ret['reward_vesting_crea']['amount'],
