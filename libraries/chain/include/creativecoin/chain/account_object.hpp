...
namespace creativecoin { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         bool              can_vote = true;
         uint16_t          voting_power = CREA_100_PERCENT;   ///< current voting power of this account, it falls after every vote
          ...
          *  CREA_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
...
FC_REFLECT( creativecoin::chain::account_object,
             ...
             (reward_creativecoin_balance)(reward_sbd_balance)(reward_vesting_balance)(reward_vesting_creativecoin)
