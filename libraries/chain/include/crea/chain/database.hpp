...
namespace crea { namespace chain {
   ...
   class database : public chainbase::database
   {
      ...
      public:
          ...
          *
          * Passing slot_num == 0 returns CREA_NULL_WITNESS
          */
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ CREA_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ CREA_NUM_HARDFORKS + 1 ];
