...
public:
  ...
  share_type                    crea_units_soft_cap = -1;
  share_type                    crea_units_hard_cap = -1;
  asset                         contributed = asset( 0, CREA_SYMBOL );
...
FC_REFLECT( crea::chain::smt_ico_object,
  (id)
  (symbol)
...
FC_REFLECT( crea::chain::smt_contribution_object,
  (id)
  (symbol)
  (contributor)
  (contribution_id)
...
CHAINBASE_SET_INDEX_TYPE( crea::chain::smt_ico_object, crea::chain::smt_ico_index )
CHAINBASE_SET_INDEX_TYPE( crea::chain::smt_token_emissions_object, crea::chain::smt_token_emissions_index )
CHAINBASE_SET_INDEX_TYPE( crea::chain::smt_contribution_object, crea::chain::smt_contribution_index )
