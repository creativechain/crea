...
class proposal_object : public object< proposal_object_type, proposal_object >
{
  ...
  public:
    ...
    time_point_sec get_end_date_with_delay() const
    {
      ...
      ret += CREA_PROPOSAL_MAINTENANCE_CLEANUP;
...
template<> struct is_static_length< crea::chain::proposal_vote_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( crea::chain::proposal_object, (id)(proposal_id)(creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink)(total_votes)(removed) )
CHAINBASE_SET_INDEX_TYPE( crea::chain::proposal_object, crea::chain::proposal_index )

FC_REFLECT( crea::chain::proposal_vote_object, (id)(voter)(proposal_id) )
CHAINBASE_SET_INDEX_TYPE( crea::chain::proposal_vote_object, crea::chain::proposal_vote_index )
