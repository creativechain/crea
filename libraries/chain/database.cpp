 ...
 */
        ...
        {
           if( has_hardfork( CREA_HARDFORK_0_17__769 ) || comment.parent_author == CREA_ROOT_POST_PARENT )
 ...
 */
        ...
        share_type database::cashout_comment_helper( util::comment_reward_context& ctx, const comment_object& comment, bool forward_curation_remainder )
        {
           try
           {
              ...
              if( comment.net_rshares > 0 )
              {
                 ...
                 if( reward_tokens > 0 )
                 {
                    share_type curation_tokens = ( ( reward_tokens * get_curation_rewards_percent( comment ) ) / CREA_100_PERCENT ).to_uint64();
         ...
         */
                  ...
                  else if( c.parent_author == CREA_ROOT_POST_PARENT )
                  {
              ...
              while( vote_itr != vote_idx.end() && vote_itr->comment == comment.id )
              {
                 ...
                 ++vote_itr;
                 if( !has_hardfork( CREA_HARDFORK_0_12__177 ) || calculate_discussion_payout_time( comment ) != fc::time_point_sec::maximum() )
                 {
        ...
        void database::init_genesis( uint64_t init_supply, uint64_t cbd_init_supply )
        {
           try
           {
              ...
              create< dynamic_global_property_object >( [&]( dynamic_global_property_object& p )
                                                        {
                                                            p.current_witness = CREA_INIT_MINER_NAME;
                                                            p.time = CREA_GENESIS_TIME;
...
struct smt_reward_balance_operator
{
           ...
           if( delta.symbol.space() == asset_symbol_type::smt_nai_space )
   {
      ...
      return;
        ...
        {
           _hardfork_times[ 0 ] = fc::time_point_sec( CREA_GENESIS_TIME );
           _hardfork_versions[ 0 ] = hardfork_version( 0, 0 );
           FC_ASSERT( CREA_HARDFORK_0_1 == 1, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_1 ] = fc::time_point_sec( CREA_HARDFORK_0_1_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_1 ] = CREA_HARDFORK_0_1_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_2 == 2, "Invlaid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_2 ] = fc::time_point_sec( CREA_HARDFORK_0_2_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_2 ] = CREA_HARDFORK_0_2_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_3 == 3, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_3 ] = fc::time_point_sec( CREA_HARDFORK_0_3_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_3 ] = CREA_HARDFORK_0_3_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_4 == 4, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_4 ] = fc::time_point_sec( CREA_HARDFORK_0_4_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_4 ] = CREA_HARDFORK_0_4_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_5 == 5, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_5 ] = fc::time_point_sec( CREA_HARDFORK_0_5_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_5 ] = CREA_HARDFORK_0_5_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_6 == 6, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_6 ] = fc::time_point_sec( CREA_HARDFORK_0_6_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_6 ] = CREA_HARDFORK_0_6_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_7 == 7, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_7 ] = fc::time_point_sec( CREA_HARDFORK_0_7_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_7 ] = CREA_HARDFORK_0_7_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_8 == 8, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_8 ] = fc::time_point_sec( CREA_HARDFORK_0_8_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_8 ] = CREA_HARDFORK_0_8_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_9 == 9, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_9 ] = fc::time_point_sec( CREA_HARDFORK_0_9_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_9 ] = CREA_HARDFORK_0_9_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_10 == 10, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_10 ] = fc::time_point_sec( CREA_HARDFORK_0_10_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_10 ] = CREA_HARDFORK_0_10_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_11 == 11, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_11 ] = fc::time_point_sec( CREA_HARDFORK_0_11_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_11 ] = CREA_HARDFORK_0_11_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_12 == 12, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_12 ] = fc::time_point_sec( CREA_HARDFORK_0_12_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_12 ] = CREA_HARDFORK_0_12_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_13 == 13, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_13 ] = fc::time_point_sec( CREA_HARDFORK_0_13_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_13 ] = CREA_HARDFORK_0_13_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_14 == 14, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_14 ] = fc::time_point_sec( CREA_HARDFORK_0_14_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_14 ] = CREA_HARDFORK_0_14_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_15 == 15, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_15 ] = fc::time_point_sec( CREA_HARDFORK_0_15_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_15 ] = CREA_HARDFORK_0_15_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_16 == 16, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_16 ] = fc::time_point_sec( CREA_HARDFORK_0_16_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_16 ] = CREA_HARDFORK_0_16_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_17 == 17, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_17 ] = fc::time_point_sec( CREA_HARDFORK_0_17_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_17 ] = CREA_HARDFORK_0_17_VERSION;
           FC_ASSERT( CREA_HARDFORK_0_18 == 18, "Invalid hardfork configuration" );
           _hardfork_times[ CREA_HARDFORK_0_18 ] = fc::time_point_sec( CREA_HARDFORK_0_18_TIME );
           _hardfork_versions[ CREA_HARDFORK_0_18 ] = CREA_HARDFORK_0_18_VERSION;
   ...
   _hardfork_versions[ CREA_HARDFORK_0_21 ] = CREA_HARDFORK_0_21_VERSION;
           ...
           FC_ASSERT( _hardfork_versions[ hardforks.last_hardfork ] <= CREA_BLOCKCHAIN_VERSION, "Blockchain version is older than last applied hardfork" );
           FC_ASSERT( CREA_BLOCKCHAIN_HARDFORK_VERSION >= CREA_BLOCKCHAIN_VERSION );
           FC_ASSERT( CREA_BLOCKCHAIN_HARDFORK_VERSION == _hardfork_versions[ CREA_NUM_HARDFORKS ] );
        }
        ...
        void database::apply_hardfork( uint32_t hardfork )
        {
           ...
           switch( hardfork )
           {
              ...
              case CREA_HARDFORK_0_12:
              {
                 ...
                 for( auto itr = comment_idx.begin(); itr != comment_idx.end(); ++itr )
                 {
                    ...
                    if( itr->parent_author == CREA_ROOT_POST_PARENT )
                    {
            ...
            */
                 ...
                 for( const auto& itr : root_posts )
                 {
                    modify( *itr, [&]( comment_object& c )
                    {
                        c.cashout_time = std::max( c.created + CREA_CASHOUT_WINDOW_SECONDS, c.cashout_time );
                    });
                 }
                 ...
                 for( const auto& itr : replies )
                 {
                    modify( *itr, [&]( comment_object& c )
                    {
                        c.cashout_time = std::max( calculate_discussion_payout_time( c ), c.created + CREA_CASHOUT_WINDOW_SECONDS );
                    });
                 }
              }
                   break;
                 ...
                 modify( get_comment( itr->parent_author, itr->parent_permlink ), [&]( comment_object& c )
         {
            c.children++;
                 ...
                 while( parent )
                 {
                    ...
                    if( parent->parent_author != CREA_ROOT_POST_PARENT )
