...
#include <creativecoin/jsonball/jsonball.hpp>
#include <creativecoin/chain/smt_objects/smt_market_maker.hpp>
...
{
   std::string mm_ticks_json = creativecoin::jsonball::get_market_maker_ticks();
