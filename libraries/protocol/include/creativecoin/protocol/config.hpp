...
#define CREA_VOTE_REGENERATION_SECONDS       (5*60*60*24) // 5 day
#define CREA_MAX_VOTE_CHANGES                5
#define CREA_REVERSE_AUCTION_WINDOW_SECONDS  (60*30) /// 30 minutes
...
#define CREA_CREATE_ACCOUNT_WITH_CREA_MODIFIER 30
...
#define CREA_DELEGATION_RETURN_PERIOD_HF20  (CREA_VOTE_REGENERATION_SECONDS * 2)
