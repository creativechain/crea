...
struct create_proposal_operation : public base_operation
{
  ...
  /// Amount of CBD to be daily paid to the `receiver` account.
  asset daily_pay;
...
struct update_proposal_operation : public base_operation
{
  ...
  /// Amount of CBDs to be daily paid to the `receiver` account, if updated, has to be lower or equal to the current amount
  asset daily_pay;
...
FC_REFLECT( crea::protocol::create_proposal_operation, (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink)(extensions) )
FC_REFLECT( crea::protocol::update_proposal_operation, (proposal_id)(creator)(daily_pay)(subject)(permlink)(extensions))
FC_REFLECT( crea::protocol::update_proposal_votes_operation, (voter)(proposal_ids)(approve)(extensions) )
FC_REFLECT( crea::protocol::remove_proposal_operation, (proposal_owner)(proposal_ids)(extensions) )
FC_REFLECT(crea::protocol::proposal_pay_operation, (receiver)(payer)(payment)(trx_id)(op_in_trx))
