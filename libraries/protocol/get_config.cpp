...
fc::variant_object get_config( const std::string& treasury_name, const fc::sha256& chain_id )
{
  ...
  result["CREA_BENEFICIARY_LIMIT"] = CREA_BENEFICIARY_LIMIT;
  ...
  result["CREA_CHAIN_ID"] = chain_id;
  result["CREA_COMMENT_REWARD_FUND_NAME"] = CREA_COMMENT_REWARD_FUND_NAME;
  result["CREA_COMMENT_TITLE_LIMIT"] = CREA_COMMENT_TITLE_LIMIT;
  result["CREA_CONTENT_APR_PERCENT"] = CREA_CONTENT_APR_PERCENT;
  result["CREA_CONTENT_CONSTANT_HF0"] = CREA_CONTENT_CONSTANT_HF0;
  result["CREA_CONTENT_CONSTANT_HF21"] = CREA_CONTENT_CONSTANT_HF21;
  result["CREA_CONTENT_REWARD_PERCENT_HF16"] = CREA_CONTENT_REWARD_PERCENT_HF16;
  result["CREA_CONTENT_REWARD_PERCENT_HF21"] = CREA_CONTENT_REWARD_PERCENT_HF21;
  ...
  result["CREA_CUSTOM_OP_DATA_MAX_LENGTH"] = CREA_CUSTOM_OP_DATA_MAX_LENGTH;
  result["CREA_CUSTOM_OP_ID_MAX_LENGTH"] = CREA_CUSTOM_OP_ID_MAX_LENGTH;
  result["CREA_DEFAULT_CBD_INTEREST_RATE"] = CREA_DEFAULT_CBD_INTEREST_RATE;
  result["CREA_DOWNVOTE_POOL_PERCENT_HF21"] = CREA_DOWNVOTE_POOL_PERCENT_HF21;
  ...
  result["CREA_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS"] = CREA_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS;
  ...
  result["CREA_MAX_PENDING_TRANSFERS"] = CREA_MAX_PENDING_TRANSFERS;
  ...
  result["CREA_MIN_COMMENT_EDIT_INTERVAL"] = CREA_MIN_COMMENT_EDIT_INTERVAL;
  ...
  result["CREA_PROPOSAL_FUND_PERCENT_HF0"] = CREA_PROPOSAL_FUND_PERCENT_HF0;
  result["CREA_PROPOSAL_FUND_PERCENT_HF21"] = CREA_PROPOSAL_FUND_PERCENT_HF21;
  ...
  result["CREA_REVERSE_AUCTION_WINDOW_SECONDS_HF21"] = CREA_REVERSE_AUCTION_WINDOW_SECONDS_HF21;
  ...
  result["CREA_VESTING_FUND_PERCENT_HF16"] = CREA_VESTING_FUND_PERCENT_HF16;
  ...
  result["CREA_BLOCK_GENERATION_POSTPONED_TX_LIMIT"] = CREA_BLOCK_GENERATION_POSTPONED_TX_LIMIT;
  result["CREA_PENDING_TRANSACTION_EXECUTION_LIMIT"] = CREA_PENDING_TRANSACTION_EXECUTION_LIMIT;
  result["CREA_TREASURY_ACCOUNT"] = treasury_name;
  result["CREA_TREASURY_FEE"] = CREA_TREASURY_FEE;
  result["CREA_PROPOSAL_MAINTENANCE_PERIOD"] = CREA_PROPOSAL_MAINTENANCE_PERIOD;
  result["CREA_PROPOSAL_MAINTENANCE_CLEANUP"] = CREA_PROPOSAL_MAINTENANCE_CLEANUP;
  result["CREA_PROPOSAL_SUBJECT_MAX_LENGTH"] = CREA_PROPOSAL_SUBJECT_MAX_LENGTH;
  result["CREA_PROPOSAL_MAX_IDS_NUMBER"] = CREA_PROPOSAL_MAX_IDS_NUMBER;
