...
#define CREA_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
CREA_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define CREA_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define CREA_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define CREA_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
CREA_DECLARE_SCHEMA_CLASS( false, false )
CREA_DECLARE_SCHEMA_CLASS(  true, false )
CREA_DECLARE_SCHEMA_CLASS(  true,  true )
