...
class wallet_api
{
   public:
       ...
       * @param amount The funds being transferred. i.e. "100.000 CREA"
      ...
      /**
       * Transfer CREA into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of CREA is vesting.
       *
       * @param from The account the CREA is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of CREA to vest i.e. "100.00 CREA"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as CREA. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or CREA.
