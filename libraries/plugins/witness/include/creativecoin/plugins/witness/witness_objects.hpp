...
{
   account_bandwidth_object_type = ( CREA_WITNESS_SPACE_ID << 8 ),
   content_edit_lock_object_type = ( CREA_WITNESS_SPACE_ID << 8 ) + 1,
   reserve_ratio_object_type     = ( CREA_WITNESS_SPACE_ID << 8 ) + 2,
};
...
class reserve_ratio_object : public object< reserve_ratio_object_type, reserve_ratio_object >
{
   public:
       ...
       *   reaches CREA_MAX_RESERVE_RATIO.  Any time average_block_size is greater than
       ...
       *
       *    max_bandwidth = maximum_block_size * CREA_BANDWIDTH_AVERAGE_WINDOW_SECONDS / CREA_BLOCK_INTERVAL
       *
