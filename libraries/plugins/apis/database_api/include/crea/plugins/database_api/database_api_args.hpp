...
FC_REFLECT_ENUM( crea::plugins::database_api::order_direction_type,
  (ascending)
  (descending) )

FC_REFLECT( crea::plugins::database_api::list_object_args_type,
  (start)(limit)(order) )
...
FC_REFLECT(crea::plugins::database_api::get_comment_pending_payouts_args,
  (comments)
)

FC_REFLECT(crea::plugins::database_api::comment_pending_payout_info,
  (author)
  (permlink)
  (cashout_info)
)

FC_REFLECT(crea::plugins::database_api::get_comment_pending_payouts_return,
  (cashout_infos)
)
...
FC_REFLECT( crea::plugins::database_api::list_proposals_args,
  (start)(limit)(order)(order_direction)(status)(last_id) )

FC_REFLECT( crea::plugins::database_api::list_proposals_return,
  (proposals) )

FC_REFLECT( crea::plugins::database_api::find_proposals_args,
  (proposal_ids) )

FC_REFLECT( crea::plugins::database_api::list_proposal_votes_return,
  (proposal_votes) )
...
FC_REFLECT( crea::plugins::database_api::get_nai_pool_return,
  (nai_pool) )

FC_REFLECT( crea::plugins::database_api::list_smt_contributions_return,
  (contributions) )

FC_REFLECT( crea::plugins::database_api::find_smt_contributions_args,
  (symbol_contributors) )

FC_REFLECT( crea::plugins::database_api::list_smt_tokens_return,
  (tokens) )

FC_REFLECT( crea::plugins::database_api::find_smt_tokens_args,
  (symbols)(ignore_precision) )

FC_REFLECT( crea::plugins::database_api::list_smt_token_emissions_return,
  (token_emissions) )

FC_REFLECT( crea::plugins::database_api::find_smt_token_emissions_args,
  (asset_symbol) )
