#include <crea/plugins/rc_api/rc_api_plugin.hpp>
#include <crea/plugins/rc_api/rc_api.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< crea::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( CREA_RC_API_PLUGIN_NAME );
}
