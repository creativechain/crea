...
struct api_comment_object
{
  ...
  legacy_asset      total_payout_value = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
  legacy_asset      curator_payout_value = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
  ...
  legacy_asset      max_accepted_payout = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
...
struct extended_dynamic_global_properties
{
  ...
  legacy_asset      init_cbd_supply = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
  legacy_asset      current_cbd_supply = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
  ...
  legacy_asset      sps_interval_ledger = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
...
struct discussion : public api_comment_object
{
  ...
  string                        root_title;
  legacy_asset                  pending_payout_value = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) ); ///< CBD
  legacy_asset                  total_pending_payout_value = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) ); ///< CBD including replies
  vector< tags::vote_state >    active_votes;
  vector< string >              replies; ///< author/slug mapping
  share_type                    author_reputation = 0;
  legacy_asset                  promoted = legacy_asset::from_asset( asset( 0, CBD_SYMBOL ) );
...
FC_REFLECT( crea::plugins::condenser_api::api_account_object,
          ...
          (comment_count)(lifetime_vote_count)(post_count)(can_vote)(voting_flowbar)(downvote_flowbar)(voting_power)
          (balance)
          (savings_balance)
...
FC_REFLECT( crea::plugins::condenser_api::extended_dynamic_global_properties,
        ...
        (virtual_supply)(current_supply)(init_cbd_supply)(current_cbd_supply)
        ...
        (vote_power_reserve_rate)(delegation_return_period)(reverse_auction_seconds)(available_account_subsidies)(cbd_stop_percent)(cbd_start_percent)
...
FC_REFLECT( crea::plugins::condenser_api::api_proposal_object,
