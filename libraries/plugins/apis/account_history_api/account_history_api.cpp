...
{
   public:
      abstract_account_history_api_impl() : _db( appbase::app().get_plugin< crea::plugins::chain::chain_plugin >().db() ) {}
...
{
   auto ah_cb = appbase::app().find_plugin< crea::plugins::account_history::account_history_plugin >();
   auto ah_rocks = appbase::app().find_plugin< crea::plugins::account_history_rocksdb::account_history_rocksdb_plugin >();
