...
// time.
//
#ifndef CREA_TAG_SPACE_ID
#define CREA_TAG_SPACE_ID 5
#endif

#define CREA_TAGS_PLUGIN_NAME "tags"
...
enum
{
   tag_object_type              = ( CREA_TAG_SPACE_ID << 8 ),
   tag_stats_object_type        = ( CREA_TAG_SPACE_ID << 8 ) + 1,
   peer_stats_object_type       = ( CREA_TAG_SPACE_ID << 8 ) + 2,
   author_tag_stats_object_type = ( CREA_TAG_SPACE_ID << 8 ) + 3
};
