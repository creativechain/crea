...
void test_alpha()
{
   ...
   gpolicy.pre_soft_cap_unit.crea_unit.emplace( "founder-a",   7 );
   gpolicy.pre_soft_cap_unit.crea_unit.emplace( "founder-b",  23 );
   gpolicy.pre_soft_cap_unit.crea_unit.emplace( "founder-c",  70 );
...
void test_delta()
{
   ...
   // .001 CREA / .100000 DELTA -> 100 DELTA / CREA
   gpolicy.min_unit_ratio = 1000;
   gpolicy.max_unit_ratio = 1000;
