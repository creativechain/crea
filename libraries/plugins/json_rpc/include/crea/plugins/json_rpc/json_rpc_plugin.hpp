...
{                                                                                               \
   crea::plugins::json_rpc::detail::register_api_method_visitor vtor( API_NAME );              \
   for_each_api( vtor );                                                                        \
}
   ...
   class register_api_method_visitor
   {
      public:
         register_api_method_visitor( const std::string& api_name )
            : _api_name( api_name ),
              _json_rpc_plugin( appbase::app().get_plugin< crea::plugins::json_rpc::json_rpc_plugin >() )
         {}
      ...
      private:
         ...
         crea::plugins::json_rpc::json_rpc_plugin& _json_rpc_plugin;
   };
...
FC_REFLECT( crea::plugins::json_rpc::api_method_signature, (args)(ret) )
