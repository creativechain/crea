...
function buildSource {
    ...
    export SNAPPY_ROOT=$LIBRARIES_DIR
    export CURSES_ROOT=$LIBRARIES_DIR
    export READLINE_ROOT=$LIBRARIES_DIR
    export BZIP2_ROOT=$LIBRARIES_DIR

    cmake -DCLEAR_VOTES=OFF -DENABLE_SMT_SUPPORT=true -DCMAKE_CXX_FLAGS_RELEASE="-fpermissive -O3" -DENABLE_CONTENT_PATCHING=OFF -DCMAKE_BUILD_TYPE=Release ..
